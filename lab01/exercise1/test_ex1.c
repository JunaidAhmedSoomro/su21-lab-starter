...
int main(int argc, char **argv) {
  ...
  printf(" There are  %d : letters  ", num_l);
  assert(num_z == 0);

  /* TODO: Think of a scenario that is not tested by the current test cases.
  Create one additional test case to test this scenario. */
  printf("Congts! ur Part 1 Test cases r all passing!\n");
  ...
  printf("Congrats! ur Part 2 Test cases are all passing!\n");
  return 0;
}
